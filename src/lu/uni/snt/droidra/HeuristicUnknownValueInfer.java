...
public class HeuristicUnknownValueInfer {
    ...
    private static UnknowValueInferService unknowValueInferService;

    private static CoalResultAccuracyVerifyService coalResultAccuracyVerifyService;
    ...
    public Map<StmtKey, StmtValue> infer(Map<StmtKey, StmtValue> stmtKeyValues) {
        stmtKeyValues = inferThroughKnownClassNames(stmtKeyValues);

        stmtKeyValues = inferThroughAllClasses(stmtKeyValues);

        stmtKeyValues = unknowValueInferService.inferClassNameThroughAllSootMethods(stmtKeyValues);

        stmtKeyValues = unknowValueInferService.inferMethodNameThroughAllSootClasses(stmtKeyValues);
